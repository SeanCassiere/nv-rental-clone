...
import { ExportToCsv } from "@/routes/_auth/(reports)/-components/view-report/plugin/export-to-csv";
import { GlobalFilter } from "@/routes/_auth/(reports)/-components/view-report/plugin/global-search";
import { ReportTable } from "@/routes/_auth/(reports)/-components/view-report/plugin/table";
