  ...
  return (
    <article className="mx-auto flex w-full max-w-[1700px] flex-1 items-center gap-6 pb-2.5 pl-3.5 pr-1 pt-3 md:px-16">
      {message.link ? (
        <a
          href={message.link}
          className="[text-wrap=balance] group flex flex-1 flex-col flex-wrap items-start text-base leading-normal text-accent-foreground sm:flex-row sm:items-center"
        ...
        <p className="flex flex-1 flex-col flex-wrap items-start text-base leading-normal text-accent-foreground sm:flex-row sm:items-center">
          <MessageText message={message} />
        </p>
      )}
